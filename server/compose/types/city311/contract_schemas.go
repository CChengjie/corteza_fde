...
func clientSchemas() map[string]map[string]interface{} {
	return map[string]map[string]interface{}{
		...
		"current_actor": object([]string{"actor_id", "display_name", "application_roles", "department_codes", "district_codes", "scopes", "available_routes"}, map[string]interface{}{
		...
		"reminder_action": object([]string{}, map[string]interface{}{
			"due_at": map[string]interface{}{"schema_ref": "timestamp", "description": "required and later than the existing due_at for SNOOZE"},
		}),
		"bulk_request": object([]string{"request_ids", "action", "changes"}, map[string]interface{}{
			"request_ids": map[string]interface{}{"type": "array", "min_items": 1, "unique_items": true, "items": map[string]interface{}{"type": "string"}},
		...
		"identity_configuration": versionedObject([]string{"oidc_enabled", "saml_enabled"}, map[string]interface{}{
			"oidc_enabled": map[string]interface{}{"type": "boolean"}, "saml_enabled": map[string]interface{}{"type": "boolean"},
			"secret_fields": map[string]interface{}{"type": "object", "write_only": true, "masked_after_save": true},
		}),
