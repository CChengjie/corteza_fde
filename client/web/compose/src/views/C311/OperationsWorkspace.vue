...
export default {
  ...
  data: () => ({ busy: false, message: '', formErrors: [], result: '', workflows: [], executions: [], reports: [], workflowJSON: emptyWorkflow(), reportJSON: emptyReport(), selectedWorkflow: null, selectedReport: null, calendarICS: '', calendarDownload: '', mail: { to: '', subject: '', html: '' } }),
