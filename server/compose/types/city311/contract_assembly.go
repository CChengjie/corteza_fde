...
func assembleContract(document *ContractDocument) {
	addProvisions(document,
		...
		"9.6.3", "9.7.3", "9.7.5", "9.8.4", "9.8.6", "10.1.3", "10.1.5", "10.2.6",
	...
	return map[string]interface{}{
		"session_and_authorization": map[string]interface{}{
			...
			"administration_role_capability_fixtures": map[string]interface{}{
				...
				"supervisor":             []string{},
				"department_manager":     []string{"admin_categories_list", "admin_categories_create", "admin_categories_update"},
				"platform_administrator": []string{"admin_help_get", "admin_help_update", "admin_help_preview", "admin_help_publish", "admin_help_versions", "admin_help_rollback", "admin_categories_list", "admin_categories_create", "admin_categories_update"},
		...
		"optimistic_concurrency": map[string]interface{}{
			...
			"applies_to":     []string{"service_request", "workflow", "branding", "content", "help", "category", "custom_field"},
			"missing_status": 428,
