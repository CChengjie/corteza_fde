...
var (
	...
	_ store.City311ConfigurationRevisions  = &Store{}
	_ store.City311Constituents            = &Store{}
	_ store.City311EmailReplacementTokens  = &Store{}
	_ store.City311IdempotencyRecords      = &Store{}
	_ store.City311IdentityNotifications   = &Store{}
	_ store.City311IdentitySessions        = &Store{}
	_ store.City311LocalAccounts           = &Store{}
	_ store.City311Operations              = &Store{}
	_ store.City311PasswordResetTokens     = &Store{}
	_ store.City311PublicHistoryItems      = &Store{}
	_ store.City311ReopenRequests          = &Store{}
	_ store.City311RequestAttachments      = &Store{}
	_ store.City311RequestConstituentLinks = &Store{}
	_ store.City311RequestNotes            = &Store{}
	_ store.City311RequestSequences        = &Store{}
	_ store.City311ServiceRequests         = &Store{}
	_ store.City311StagedAttachments       = &Store{}
	_ store.City311WorkflowDefinitions     = &Store{}
	_ store.City311WorkflowExecutions      = &Store{}
...
// CreateCity311ConfigurationRevision creates one or more rows in city311ConfigurationRevision collection
//
// This function is auto-generated
func (s *Store) CreateCity311ConfigurationRevision(ctx context.Context, rr ...*composeType.City311ConfigurationRevision) (err error) {
	for i := range rr {
		if err = s.checkCity311ConfigurationRevisionConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311ConfigurationRevisionInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateCity311ConfigurationRevision updates one or more existing entries in city311ConfigurationRevision collection
//
// This function is auto-generated
func (s *Store) UpdateCity311ConfigurationRevision(ctx context.Context, rr ...*composeType.City311ConfigurationRevision) (err error) {
	for i := range rr {
		if err = s.checkCity311ConfigurationRevisionConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311ConfigurationRevisionUpdateQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpsertCity311ConfigurationRevision updates one or more existing entries in city311ConfigurationRevision collection
//
// This function is auto-generated
func (s *Store) UpsertCity311ConfigurationRevision(ctx context.Context, rr ...*composeType.City311ConfigurationRevision) (err error) {
	for i := range rr {
		if err = s.checkCity311ConfigurationRevisionConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, city311ConfigurationRevisionUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, city311ConfigurationRevisionInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, city311ConfigurationRevisionUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteCity311ConfigurationRevision Deletes one or more entries from city311ConfigurationRevision collection
//
// This function is auto-generated
func (s *Store) DeleteCity311ConfigurationRevision(ctx context.Context, rr ...*composeType.City311ConfigurationRevision) (err error) {
	for i := range rr {
		if err = s.Exec(ctx, city311ConfigurationRevisionDeleteQuery(s.Dialect.GOQU(), city311ConfigurationRevisionPrimaryKeys(rr[i]))); err != nil {
			return
		}
	}
...
// DeleteCity311ConfigurationRevisionByID deletes single entry from city311ConfigurationRevision collection
//
// This function is auto-generated
func (s *Store) DeleteCity311ConfigurationRevisionByID(ctx context.Context, id uint64) error {
	return s.Exec(ctx, city311ConfigurationRevisionDeleteQuery(s.Dialect.GOQU(), goqu.Ex{
		"id": id,
	}))
}

// TruncateCity311ConfigurationRevisions Deletes all rows from the city311ConfigurationRevision collection
func (s *Store) TruncateCity311ConfigurationRevisions(ctx context.Context) error {
	return s.Exec(ctx, city311ConfigurationRevisionTruncateQuery(s.Dialect.GOQU()))
}

// SearchCity311ConfigurationRevisions returns (filtered) set of City311ConfigurationRevisions
//
// This function is auto-generated
func (s *Store) SearchCity311ConfigurationRevisions(ctx context.Context, f composeType.City311ConfigurationRevisionFilter) (set composeType.City311ConfigurationRevisionSet, _ composeType.City311ConfigurationRevisionFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfCity311ConfigurationRevisions fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfCity311ConfigurationRevisions(ctx, f, sort)
	...
	if f.IncTotal {
		...
		if f.Limit > 0 && uint(len(set)) == f.Limit {
			...
			limit := f.Limit
			f.Limit = 0
			var navSet composeType.City311ConfigurationRevisionSet
			if navSet, _, _, err = s.fetchFullPageOfCity311ConfigurationRevisions(ctx, f, sort); err != nil {
				return
			} else {
				f.Total = uint(len(navSet))
				f.Limit = limit
...
// fetchFullPageOfCity311ConfigurationRevisions collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfCity311ConfigurationRevisions(
	ctx context.Context,
	filter composeType.City311ConfigurationRevisionFilter,
	sort filter.SortExprSet,
) (set []*composeType.City311ConfigurationRevision, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*composeType.City311ConfigurationRevision
		...
		tryFilter composeType.City311ConfigurationRevisionFilter
	)

	set = make([]*composeType.City311ConfigurationRevision, 0, DefaultSliceCapacity)
	...
	for try := 0; try < MaxRefetches; try++ {
		...
		if aux, hasNext, err = s.QueryCity311ConfigurationRevisions(ctx, tryFilter); err != nil {
			return nil, nil, nil, err
		}
		...
		if reqItems > collected {
			...
			// Update cursor so that it points to the last item fetched
			tryFilter.PageCursor = s.collectCity311ConfigurationRevisionCursorValues(set[collected-1], filter.Sort...)
	...
	if hasPrev {
		prev = s.collectCity311ConfigurationRevisionCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectCity311ConfigurationRevisionCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
// QueryCity311ConfigurationRevisions queries the database, converts and checks each row and returns collected set
//
// With generics, we can remove this per-resource-generated function
// and replace it with a single utility fetcher
//
// This function is auto-generated
func (s *Store) QueryCity311ConfigurationRevisions(
	ctx context.Context,
	f composeType.City311ConfigurationRevisionFilter,
) (_ []*composeType.City311ConfigurationRevision, more bool, err error) {
	var (
		ok bool

		set         = make([]*composeType.City311ConfigurationRevision, 0, DefaultSliceCapacity)
		res         *composeType.City311ConfigurationRevision
		aux         *auxCity311ConfigurationRevision
		rows        *sql.Rows
		count       uint
		expr, tExpr []goqu.Expression
	...
	if s.Filters.City311ConfigurationRevision != nil {
		// extended filter set
		tExpr, f, err = s.Filters.City311ConfigurationRevision(s, f)
	} else {
		// using generated filter
		tExpr, f, err = City311ConfigurationRevisionFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for City311ConfigurationRevision: %w", err)
		return
	}
	...
	// paging feature is enabled
	if f.PageCursor != nil {
		if tExpr, err = cursorWithSorting(f.PageCursor, s.sortableCity311ConfigurationRevisionFields()); err != nil {
			return
		} else {
			expr = append(expr, tExpr...)
		}
	...
	query := city311ConfigurationRevisionSelectQuery(s.Dialect.GOQU()).Where(expr...)

	// sorting feature is enabled
	if sortExpr, err = order(f.Sort, s.sortableCity311ConfigurationRevisionFields()); err != nil {
		err = fmt.Errorf("could not generate order expression for City311ConfigurationRevision: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query City311ConfigurationRevision: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		aux = new(auxCity311ConfigurationRevision)
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for City311ConfigurationRevision: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode City311ConfigurationRevision: %w", err)
			return
		}
...
//
// This function is auto-generated
func (s *Store) LookupCity311ConfigurationRevisionByID(ctx context.Context, id uint64) (_ *composeType.City311ConfigurationRevision, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311ConfigurationRevision)
		lookup = city311ConfigurationRevisionSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("id").Eq(id),
		).Limit(1)
	)
...
// sortableCity311ConfigurationRevisionFields returns all <no value> columns flagged as sortable
//
// # Notes
// With optional string arg, all columns are returned aliased
//
// This function is auto-generated
func (Store) sortableCity311ConfigurationRevisionFields() map[string]string {
	return map[string]string{
		"created_at":    "created_at",
		"createdat":     "created_at",
		"id":            "id",
...
// collectCity311ConfigurationRevisionCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectCity311ConfigurationRevisionCursorValues(res *composeType.City311ConfigurationRevision, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
...
// checkCity311ConfigurationRevisionConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkCity311ConfigurationRevisionConstraints(ctx context.Context, res *composeType.City311ConfigurationRevision) (err error) {
	return nil
}
...
// CreateCity311EmailReplacementToken creates one or more rows in city311EmailReplacementToken collection
//
// This function is auto-generated
func (s *Store) CreateCity311EmailReplacementToken(ctx context.Context, rr ...*composeType.City311EmailReplacementToken) (err error) {
	for i := range rr {
		if err = s.checkCity311EmailReplacementTokenConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311EmailReplacementTokenInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateCity311EmailReplacementToken updates one or more existing entries in city311EmailReplacementToken collection
//
// This function is auto-generated
func (s *Store) UpdateCity311EmailReplacementToken(ctx context.Context, rr ...*composeType.City311EmailReplacementToken) (err error) {
	for i := range rr {
		if err = s.checkCity311EmailReplacementTokenConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311EmailReplacementTokenUpdateQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpsertCity311EmailReplacementToken updates one or more existing entries in city311EmailReplacementToken collection
//
// This function is auto-generated
func (s *Store) UpsertCity311EmailReplacementToken(ctx context.Context, rr ...*composeType.City311EmailReplacementToken) (err error) {
	for i := range rr {
		if err = s.checkCity311EmailReplacementTokenConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, city311EmailReplacementTokenUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, city311EmailReplacementTokenInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, city311EmailReplacementTokenUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteCity311EmailReplacementToken Deletes one or more entries from city311EmailReplacementToken collection
//
// This function is auto-generated
func (s *Store) DeleteCity311EmailReplacementToken(ctx context.Context, rr ...*composeType.City311EmailReplacementToken) (err error) {
	for i := range rr {
		if err = s.Exec(ctx, city311EmailReplacementTokenDeleteQuery(s.Dialect.GOQU(), city311EmailReplacementTokenPrimaryKeys(rr[i]))); err != nil {
			return
		}
	}
...
// DeleteCity311EmailReplacementTokenByID deletes single entry from city311EmailReplacementToken collection
//
// This function is auto-generated
func (s *Store) DeleteCity311EmailReplacementTokenByID(ctx context.Context, id uint64) error {
	return s.Exec(ctx, city311EmailReplacementTokenDeleteQuery(s.Dialect.GOQU(), goqu.Ex{
		"id": id,
	}))
}

// TruncateCity311EmailReplacementTokens Deletes all rows from the city311EmailReplacementToken collection
func (s *Store) TruncateCity311EmailReplacementTokens(ctx context.Context) error {
	return s.Exec(ctx, city311EmailReplacementTokenTruncateQuery(s.Dialect.GOQU()))
}

// SearchCity311EmailReplacementTokens returns (filtered) set of City311EmailReplacementTokens
//
// This function is auto-generated
func (s *Store) SearchCity311EmailReplacementTokens(ctx context.Context, f composeType.City311EmailReplacementTokenFilter) (set composeType.City311EmailReplacementTokenSet, _ composeType.City311EmailReplacementTokenFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfCity311EmailReplacementTokens fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfCity311EmailReplacementTokens(ctx, f, sort)
	...
	if f.IncTotal {
		...
		if f.Limit > 0 && uint(len(set)) == f.Limit {
			...
			limit := f.Limit
			f.Limit = 0
			var navSet composeType.City311EmailReplacementTokenSet
			if navSet, _, _, err = s.fetchFullPageOfCity311EmailReplacementTokens(ctx, f, sort); err != nil {
				return
			} else {
				f.Total = uint(len(navSet))
				f.Limit = limit
...
// fetchFullPageOfCity311EmailReplacementTokens collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfCity311EmailReplacementTokens(
	ctx context.Context,
	filter composeType.City311EmailReplacementTokenFilter,
	sort filter.SortExprSet,
) (set []*composeType.City311EmailReplacementToken, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*composeType.City311EmailReplacementToken
		...
		tryFilter composeType.City311EmailReplacementTokenFilter
	)

	set = make([]*composeType.City311EmailReplacementToken, 0, DefaultSliceCapacity)
	...
	for try := 0; try < MaxRefetches; try++ {
		...
		if aux, hasNext, err = s.QueryCity311EmailReplacementTokens(ctx, tryFilter); err != nil {
			return nil, nil, nil, err
		}
		...
		if reqItems > collected {
			...
			// Update cursor so that it points to the last item fetched
			tryFilter.PageCursor = s.collectCity311EmailReplacementTokenCursorValues(set[collected-1], filter.Sort...)
	...
	if hasPrev {
		prev = s.collectCity311EmailReplacementTokenCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectCity311EmailReplacementTokenCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
// QueryCity311EmailReplacementTokens queries the database, converts and checks each row and returns collected set
//
// With generics, we can remove this per-resource-generated function
// and replace it with a single utility fetcher
//
// This function is auto-generated
func (s *Store) QueryCity311EmailReplacementTokens(
	ctx context.Context,
	f composeType.City311EmailReplacementTokenFilter,
) (_ []*composeType.City311EmailReplacementToken, more bool, err error) {
	var (
		ok bool

		set         = make([]*composeType.City311EmailReplacementToken, 0, DefaultSliceCapacity)
		res         *composeType.City311EmailReplacementToken
		aux         *auxCity311EmailReplacementToken
		rows        *sql.Rows
		count       uint
		expr, tExpr []goqu.Expression
	...
	if s.Filters.City311EmailReplacementToken != nil {
		// extended filter set
		tExpr, f, err = s.Filters.City311EmailReplacementToken(s, f)
	} else {
		// using generated filter
		tExpr, f, err = City311EmailReplacementTokenFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for City311EmailReplacementToken: %w", err)
		return
	}
	...
	// paging feature is enabled
	if f.PageCursor != nil {
		if tExpr, err = cursorWithSorting(f.PageCursor, s.sortableCity311EmailReplacementTokenFields()); err != nil {
			return
		} else {
			expr = append(expr, tExpr...)
		}
	...
	query := city311EmailReplacementTokenSelectQuery(s.Dialect.GOQU()).Where(expr...)

	// sorting feature is enabled
	if sortExpr, err = order(f.Sort, s.sortableCity311EmailReplacementTokenFields()); err != nil {
		err = fmt.Errorf("could not generate order expression for City311EmailReplacementToken: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query City311EmailReplacementToken: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		aux = new(auxCity311EmailReplacementToken)
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for City311EmailReplacementToken: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode City311EmailReplacementToken: %w", err)
			return
		}
...
//
// This function is auto-generated
func (s *Store) LookupCity311EmailReplacementTokenByID(ctx context.Context, id uint64) (_ *composeType.City311EmailReplacementToken, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311EmailReplacementToken)
		lookup = city311EmailReplacementTokenSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("id").Eq(id),
		).Limit(1)
	)
...
//
// This function is auto-generated
func (s *Store) LookupCity311EmailReplacementTokenByTokenHash(ctx context.Context, tokenHash string) (_ *composeType.City311EmailReplacementToken, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311EmailReplacementToken)
		lookup = city311EmailReplacementTokenSelectQuery(s.Dialect.GOQU()).Where(
...
// sortableCity311EmailReplacementTokenFields returns all <no value> columns flagged as sortable
//
// # Notes
// With optional string arg, all columns are returned aliased
//
// This function is auto-generated
func (Store) sortableCity311EmailReplacementTokenFields() map[string]string {
	return map[string]string{
		"created_at": "created_at",
		"createdat":  "created_at",
		"expires_at": "expires_at",
...
// collectCity311EmailReplacementTokenCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectCity311EmailReplacementTokenCursorValues(res *composeType.City311EmailReplacementToken, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
...
// checkCity311EmailReplacementTokenConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkCity311EmailReplacementTokenConstraints(ctx context.Context, res *composeType.City311EmailReplacementToken) (err error) {
	err = func() (err error) {
		...
		ex, err := s.LookupCity311EmailReplacementTokenByTokenHash(ctx, res.TokenHash)
		if err == nil && ex != nil && ex.ID != res.ID {
			return store.ErrNotUnique.Stack(1)
		} else if !errors.IsNotFound(err) {
			return err
...
// CreateCity311IdentityNotification creates one or more rows in city311IdentityNotification collection
//
// This function is auto-generated
func (s *Store) CreateCity311IdentityNotification(ctx context.Context, rr ...*composeType.City311IdentityNotification) (err error) {
	for i := range rr {
		if err = s.checkCity311IdentityNotificationConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311IdentityNotificationInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateCity311IdentityNotification updates one or more existing entries in city311IdentityNotification collection
//
// This function is auto-generated
func (s *Store) UpdateCity311IdentityNotification(ctx context.Context, rr ...*composeType.City311IdentityNotification) (err error) {
	for i := range rr {
		if err = s.checkCity311IdentityNotificationConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311IdentityNotificationUpdateQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpsertCity311IdentityNotification updates one or more existing entries in city311IdentityNotification collection
//
// This function is auto-generated
func (s *Store) UpsertCity311IdentityNotification(ctx context.Context, rr ...*composeType.City311IdentityNotification) (err error) {
	for i := range rr {
		if err = s.checkCity311IdentityNotificationConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, city311IdentityNotificationUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, city311IdentityNotificationInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, city311IdentityNotificationUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteCity311IdentityNotification Deletes one or more entries from city311IdentityNotification collection
//
// This function is auto-generated
func (s *Store) DeleteCity311IdentityNotification(ctx context.Context, rr ...*composeType.City311IdentityNotification) (err error) {
	for i := range rr {
		if err = s.Exec(ctx, city311IdentityNotificationDeleteQuery(s.Dialect.GOQU(), city311IdentityNotificationPrimaryKeys(rr[i]))); err != nil {
			return
		}
	}
...
// DeleteCity311IdentityNotificationByID deletes single entry from city311IdentityNotification collection
//
// This function is auto-generated
func (s *Store) DeleteCity311IdentityNotificationByID(ctx context.Context, id uint64) error {
	return s.Exec(ctx, city311IdentityNotificationDeleteQuery(s.Dialect.GOQU(), goqu.Ex{
		"id": id,
	}))
}

// TruncateCity311IdentityNotifications Deletes all rows from the city311IdentityNotification collection
func (s *Store) TruncateCity311IdentityNotifications(ctx context.Context) error {
	return s.Exec(ctx, city311IdentityNotificationTruncateQuery(s.Dialect.GOQU()))
}

// SearchCity311IdentityNotifications returns (filtered) set of City311IdentityNotifications
//
// This function is auto-generated
func (s *Store) SearchCity311IdentityNotifications(ctx context.Context, f composeType.City311IdentityNotificationFilter) (set composeType.City311IdentityNotificationSet, _ composeType.City311IdentityNotificationFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfCity311IdentityNotifications fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfCity311IdentityNotifications(ctx, f, sort)
	...
	if f.IncTotal {
		...
		if f.Limit > 0 && uint(len(set)) == f.Limit {
			...
			limit := f.Limit
			f.Limit = 0
			var navSet composeType.City311IdentityNotificationSet
			if navSet, _, _, err = s.fetchFullPageOfCity311IdentityNotifications(ctx, f, sort); err != nil {
				return
			} else {
				f.Total = uint(len(navSet))
				f.Limit = limit
...
// fetchFullPageOfCity311IdentityNotifications collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfCity311IdentityNotifications(
	ctx context.Context,
	filter composeType.City311IdentityNotificationFilter,
	sort filter.SortExprSet,
) (set []*composeType.City311IdentityNotification, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*composeType.City311IdentityNotification
		...
		tryFilter composeType.City311IdentityNotificationFilter
	)

	set = make([]*composeType.City311IdentityNotification, 0, DefaultSliceCapacity)
	...
	for try := 0; try < MaxRefetches; try++ {
		...
		if aux, hasNext, err = s.QueryCity311IdentityNotifications(ctx, tryFilter); err != nil {
			return nil, nil, nil, err
		}
		...
		if reqItems > collected {
			...
			// Update cursor so that it points to the last item fetched
			tryFilter.PageCursor = s.collectCity311IdentityNotificationCursorValues(set[collected-1], filter.Sort...)
	...
	if hasPrev {
		prev = s.collectCity311IdentityNotificationCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectCity311IdentityNotificationCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
// QueryCity311IdentityNotifications queries the database, converts and checks each row and returns collected set
//
// With generics, we can remove this per-resource-generated function
// and replace it with a single utility fetcher
//
// This function is auto-generated
func (s *Store) QueryCity311IdentityNotifications(
	ctx context.Context,
	f composeType.City311IdentityNotificationFilter,
) (_ []*composeType.City311IdentityNotification, more bool, err error) {
	var (
		ok bool

		set         = make([]*composeType.City311IdentityNotification, 0, DefaultSliceCapacity)
		res         *composeType.City311IdentityNotification
		aux         *auxCity311IdentityNotification
		rows        *sql.Rows
		count       uint
		expr, tExpr []goqu.Expression
	...
	if s.Filters.City311IdentityNotification != nil {
		// extended filter set
		tExpr, f, err = s.Filters.City311IdentityNotification(s, f)
	} else {
		// using generated filter
		tExpr, f, err = City311IdentityNotificationFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for City311IdentityNotification: %w", err)
		return
	}
	...
	// paging feature is enabled
	if f.PageCursor != nil {
		if tExpr, err = cursorWithSorting(f.PageCursor, s.sortableCity311IdentityNotificationFields()); err != nil {
			return
		} else {
			expr = append(expr, tExpr...)
		}
	...
	query := city311IdentityNotificationSelectQuery(s.Dialect.GOQU()).Where(expr...)

	// sorting feature is enabled
	if sortExpr, err = order(f.Sort, s.sortableCity311IdentityNotificationFields()); err != nil {
		err = fmt.Errorf("could not generate order expression for City311IdentityNotification: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query City311IdentityNotification: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		aux = new(auxCity311IdentityNotification)
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for City311IdentityNotification: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode City311IdentityNotification: %w", err)
			return
		}
...
//
// This function is auto-generated
func (s *Store) LookupCity311IdentityNotificationByID(ctx context.Context, id uint64) (_ *composeType.City311IdentityNotification, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311IdentityNotification)
		lookup = city311IdentityNotificationSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("id").Eq(id),
		).Limit(1)
	)
...
// sortableCity311IdentityNotificationFields returns all <no value> columns flagged as sortable
//
// # Notes
// With optional string arg, all columns are returned aliased
//
// This function is auto-generated
func (Store) sortableCity311IdentityNotificationFields() map[string]string {
	return map[string]string{
		"created_at": "created_at",
		"createdat":  "created_at",
		"id":         "id",
...
// collectCity311IdentityNotificationCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectCity311IdentityNotificationCursorValues(res *composeType.City311IdentityNotification, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
...
// checkCity311IdentityNotificationConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkCity311IdentityNotificationConstraints(ctx context.Context, res *composeType.City311IdentityNotification) (err error) {
	return nil
}

// CreateCity311IdentitySession creates one or more rows in city311IdentitySession collection
//
// This function is auto-generated
func (s *Store) CreateCity311IdentitySession(ctx context.Context, rr ...*composeType.City311IdentitySession) (err error) {
	for i := range rr {
		if err = s.checkCity311IdentitySessionConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311IdentitySessionInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateCity311IdentitySession updates one or more existing entries in city311IdentitySession collection
//
// This function is auto-generated
func (s *Store) UpdateCity311IdentitySession(ctx context.Context, rr ...*composeType.City311IdentitySession) (err error) {
	for i := range rr {
		if err = s.checkCity311IdentitySessionConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311IdentitySessionUpdateQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpsertCity311IdentitySession updates one or more existing entries in city311IdentitySession collection
//
// This function is auto-generated
func (s *Store) UpsertCity311IdentitySession(ctx context.Context, rr ...*composeType.City311IdentitySession) (err error) {
	for i := range rr {
		if err = s.checkCity311IdentitySessionConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, city311IdentitySessionUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, city311IdentitySessionInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, city311IdentitySessionUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteCity311IdentitySession Deletes one or more entries from city311IdentitySession collection
//
// This function is auto-generated
func (s *Store) DeleteCity311IdentitySession(ctx context.Context, rr ...*composeType.City311IdentitySession) (err error) {
	for i := range rr {
		if err = s.Exec(ctx, city311IdentitySessionDeleteQuery(s.Dialect.GOQU(), city311IdentitySessionPrimaryKeys(rr[i]))); err != nil {
			return
		}
	}
...
// DeleteCity311IdentitySessionByID deletes single entry from city311IdentitySession collection
//
// This function is auto-generated
func (s *Store) DeleteCity311IdentitySessionByID(ctx context.Context, id uint64) error {
	return s.Exec(ctx, city311IdentitySessionDeleteQuery(s.Dialect.GOQU(), goqu.Ex{
		"id": id,
	}))
}

// TruncateCity311IdentitySessions Deletes all rows from the city311IdentitySession collection
func (s *Store) TruncateCity311IdentitySessions(ctx context.Context) error {
	return s.Exec(ctx, city311IdentitySessionTruncateQuery(s.Dialect.GOQU()))
}

// SearchCity311IdentitySessions returns (filtered) set of City311IdentitySessions
//
// This function is auto-generated
func (s *Store) SearchCity311IdentitySessions(ctx context.Context, f composeType.City311IdentitySessionFilter) (set composeType.City311IdentitySessionSet, _ composeType.City311IdentitySessionFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfCity311IdentitySessions fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfCity311IdentitySessions(ctx, f, sort)
	...
	if f.IncTotal {
		...
		if f.Limit > 0 && uint(len(set)) == f.Limit {
			...
			limit := f.Limit
			f.Limit = 0
			var navSet composeType.City311IdentitySessionSet
			if navSet, _, _, err = s.fetchFullPageOfCity311IdentitySessions(ctx, f, sort); err != nil {
				return
			} else {
				f.Total = uint(len(navSet))
				f.Limit = limit
...
// fetchFullPageOfCity311IdentitySessions collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfCity311IdentitySessions(
	ctx context.Context,
	filter composeType.City311IdentitySessionFilter,
	sort filter.SortExprSet,
) (set []*composeType.City311IdentitySession, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*composeType.City311IdentitySession
		...
		tryFilter composeType.City311IdentitySessionFilter
	)

	set = make([]*composeType.City311IdentitySession, 0, DefaultSliceCapacity)
	...
	for try := 0; try < MaxRefetches; try++ {
		...
		if aux, hasNext, err = s.QueryCity311IdentitySessions(ctx, tryFilter); err != nil {
			return nil, nil, nil, err
		}
		...
		if reqItems > collected {
			...
			// Update cursor so that it points to the last item fetched
			tryFilter.PageCursor = s.collectCity311IdentitySessionCursorValues(set[collected-1], filter.Sort...)
	...
	if hasPrev {
		prev = s.collectCity311IdentitySessionCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectCity311IdentitySessionCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
// QueryCity311IdentitySessions queries the database, converts and checks each row and returns collected set
//
// With generics, we can remove this per-resource-generated function
// and replace it with a single utility fetcher
//
// This function is auto-generated
func (s *Store) QueryCity311IdentitySessions(
	ctx context.Context,
	f composeType.City311IdentitySessionFilter,
) (_ []*composeType.City311IdentitySession, more bool, err error) {
	var (
		ok bool

		set         = make([]*composeType.City311IdentitySession, 0, DefaultSliceCapacity)
		res         *composeType.City311IdentitySession
		aux         *auxCity311IdentitySession
		rows        *sql.Rows
		count       uint
		expr, tExpr []goqu.Expression
	...
	if s.Filters.City311IdentitySession != nil {
		// extended filter set
		tExpr, f, err = s.Filters.City311IdentitySession(s, f)
	} else {
		// using generated filter
		tExpr, f, err = City311IdentitySessionFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for City311IdentitySession: %w", err)
		return
	}
	...
	// paging feature is enabled
	if f.PageCursor != nil {
		if tExpr, err = cursorWithSorting(f.PageCursor, s.sortableCity311IdentitySessionFields()); err != nil {
			return
		} else {
			expr = append(expr, tExpr...)
		}
	...
	query := city311IdentitySessionSelectQuery(s.Dialect.GOQU()).Where(expr...)

	// sorting feature is enabled
	if sortExpr, err = order(f.Sort, s.sortableCity311IdentitySessionFields()); err != nil {
		err = fmt.Errorf("could not generate order expression for City311IdentitySession: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query City311IdentitySession: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		aux = new(auxCity311IdentitySession)
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for City311IdentitySession: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode City311IdentitySession: %w", err)
			return
		}
...
//
// This function is auto-generated
func (s *Store) LookupCity311IdentitySessionByID(ctx context.Context, id uint64) (_ *composeType.City311IdentitySession, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311IdentitySession)
		lookup = city311IdentitySessionSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("id").Eq(id),
		).Limit(1)
	)
...
//
// This function is auto-generated
func (s *Store) LookupCity311IdentitySessionByTokenHash(ctx context.Context, tokenHash string) (_ *composeType.City311IdentitySession, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311IdentitySession)
		lookup = city311IdentitySessionSelectQuery(s.Dialect.GOQU()).Where(
...
// sortableCity311IdentitySessionFields returns all <no value> columns flagged as sortable
//
// # Notes
// With optional string arg, all columns are returned aliased
//
// This function is auto-generated
func (Store) sortableCity311IdentitySessionFields() map[string]string {
	return map[string]string{
...
// collectCity311IdentitySessionCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectCity311IdentitySessionCursorValues(res *composeType.City311IdentitySession, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
...
// checkCity311IdentitySessionConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkCity311IdentitySessionConstraints(ctx context.Context, res *composeType.City311IdentitySession) (err error) {
	err = func() (err error) {
		...
		ex, err := s.LookupCity311IdentitySessionByTokenHash(ctx, res.TokenHash)
		if err == nil && ex != nil && ex.ID != res.ID {
			return store.ErrNotUnique.Stack(1)
		} else if !errors.IsNotFound(err) {
			return err
...
// CreateCity311LocalAccount creates one or more rows in city311LocalAccount collection
//
// This function is auto-generated
func (s *Store) CreateCity311LocalAccount(ctx context.Context, rr ...*composeType.City311LocalAccount) (err error) {
	for i := range rr {
		if err = s.checkCity311LocalAccountConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311LocalAccountInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateCity311LocalAccount updates one or more existing entries in city311LocalAccount collection
//
// This function is auto-generated
func (s *Store) UpdateCity311LocalAccount(ctx context.Context, rr ...*composeType.City311LocalAccount) (err error) {
	for i := range rr {
		if err = s.checkCity311LocalAccountConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311LocalAccountUpdateQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpsertCity311LocalAccount updates one or more existing entries in city311LocalAccount collection
//
// This function is auto-generated
func (s *Store) UpsertCity311LocalAccount(ctx context.Context, rr ...*composeType.City311LocalAccount) (err error) {
	for i := range rr {
		if err = s.checkCity311LocalAccountConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, city311LocalAccountUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, city311LocalAccountInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, city311LocalAccountUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteCity311LocalAccount Deletes one or more entries from city311LocalAccount collection
//
// This function is auto-generated
func (s *Store) DeleteCity311LocalAccount(ctx context.Context, rr ...*composeType.City311LocalAccount) (err error) {
	for i := range rr {
		if err = s.Exec(ctx, city311LocalAccountDeleteQuery(s.Dialect.GOQU(), city311LocalAccountPrimaryKeys(rr[i]))); err != nil {
			return
		}
	}
...
// DeleteCity311LocalAccountByID deletes single entry from city311LocalAccount collection
//
// This function is auto-generated
func (s *Store) DeleteCity311LocalAccountByID(ctx context.Context, id uint64) error {
	return s.Exec(ctx, city311LocalAccountDeleteQuery(s.Dialect.GOQU(), goqu.Ex{
		"id": id,
	}))
}

// TruncateCity311LocalAccounts Deletes all rows from the city311LocalAccount collection
func (s *Store) TruncateCity311LocalAccounts(ctx context.Context) error {
	return s.Exec(ctx, city311LocalAccountTruncateQuery(s.Dialect.GOQU()))
}

// SearchCity311LocalAccounts returns (filtered) set of City311LocalAccounts
//
// This function is auto-generated
func (s *Store) SearchCity311LocalAccounts(ctx context.Context, f composeType.City311LocalAccountFilter) (set composeType.City311LocalAccountSet, _ composeType.City311LocalAccountFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfCity311LocalAccounts fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfCity311LocalAccounts(ctx, f, sort)
	...
	if f.IncTotal {
		...
		if f.Limit > 0 && uint(len(set)) == f.Limit {
			...
			limit := f.Limit
			f.Limit = 0
			var navSet composeType.City311LocalAccountSet
			if navSet, _, _, err = s.fetchFullPageOfCity311LocalAccounts(ctx, f, sort); err != nil {
				return
			} else {
				f.Total = uint(len(navSet))
				f.Limit = limit
...
// fetchFullPageOfCity311LocalAccounts collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfCity311LocalAccounts(
	ctx context.Context,
	filter composeType.City311LocalAccountFilter,
	sort filter.SortExprSet,
) (set []*composeType.City311LocalAccount, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*composeType.City311LocalAccount
		...
		tryFilter composeType.City311LocalAccountFilter
	)

	set = make([]*composeType.City311LocalAccount, 0, DefaultSliceCapacity)
	...
	for try := 0; try < MaxRefetches; try++ {
		...
		if aux, hasNext, err = s.QueryCity311LocalAccounts(ctx, tryFilter); err != nil {
			return nil, nil, nil, err
		}
		...
		if reqItems > collected {
			...
			// Update cursor so that it points to the last item fetched
			tryFilter.PageCursor = s.collectCity311LocalAccountCursorValues(set[collected-1], filter.Sort...)
	...
	if hasPrev {
		prev = s.collectCity311LocalAccountCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectCity311LocalAccountCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
// QueryCity311LocalAccounts queries the database, converts and checks each row and returns collected set
//
// With generics, we can remove this per-resource-generated function
// and replace it with a single utility fetcher
//
// This function is auto-generated
func (s *Store) QueryCity311LocalAccounts(
	ctx context.Context,
	f composeType.City311LocalAccountFilter,
) (_ []*composeType.City311LocalAccount, more bool, err error) {
	var (
		ok bool

		set         = make([]*composeType.City311LocalAccount, 0, DefaultSliceCapacity)
		res         *composeType.City311LocalAccount
		aux         *auxCity311LocalAccount
		rows        *sql.Rows
		count       uint
		expr, tExpr []goqu.Expression
	...
	if s.Filters.City311LocalAccount != nil {
		// extended filter set
		tExpr, f, err = s.Filters.City311LocalAccount(s, f)
	} else {
		// using generated filter
		tExpr, f, err = City311LocalAccountFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for City311LocalAccount: %w", err)
		return
	}
	...
	// paging feature is enabled
	if f.PageCursor != nil {
		if tExpr, err = cursorWithSorting(f.PageCursor, s.sortableCity311LocalAccountFields()); err != nil {
			return
		} else {
			expr = append(expr, tExpr...)
		}
	...
	query := city311LocalAccountSelectQuery(s.Dialect.GOQU()).Where(expr...)

	// sorting feature is enabled
	if sortExpr, err = order(f.Sort, s.sortableCity311LocalAccountFields()); err != nil {
		err = fmt.Errorf("could not generate order expression for City311LocalAccount: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query City311LocalAccount: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		aux = new(auxCity311LocalAccount)
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for City311LocalAccount: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode City311LocalAccount: %w", err)
			return
		}
...
//
// This function is auto-generated
func (s *Store) LookupCity311LocalAccountByID(ctx context.Context, id uint64) (_ *composeType.City311LocalAccount, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311LocalAccount)
		lookup = city311LocalAccountSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("id").Eq(id),
		).Limit(1)
	)
...
//
// This function is auto-generated
func (s *Store) LookupCity311LocalAccountByLoginIdentifier(ctx context.Context, loginIdentifier string) (_ *composeType.City311LocalAccount, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311LocalAccount)
		lookup = city311LocalAccountSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("login_identifier").Eq(loginIdentifier),
		).Limit(1)
	)
...
//
// This function is auto-generated
func (s *Store) LookupCity311LocalAccountByVerifiedEmail(ctx context.Context, verifiedEmail string) (_ *composeType.City311LocalAccount, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311LocalAccount)
		lookup = city311LocalAccountSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("verified_email").Eq(verifiedEmail),
		).Limit(1)
	)
...
// sortableCity311LocalAccountFields returns all <no value> columns flagged as sortable
//
// # Notes
// With optional string arg, all columns are returned aliased
//
// This function is auto-generated
func (Store) sortableCity311LocalAccountFields() map[string]string {
	return map[string]string{
		"created_at":       "created_at",
		"createdat":        "created_at",
		"id":               "id",
...
// collectCity311LocalAccountCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectCity311LocalAccountCursorValues(res *composeType.City311LocalAccount, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
		...
		collect = func(cc ...*filter.SortExpr) {
			getVal := func(col string) interface{} {
				...
				case "loginIdentifier":
					return res.LoginIdentifier
				case "verifiedEmail":
					return res.VerifiedEmail
				case "createdAt":
					return res.CreatedAt
				case "updatedAt":
					return res.UpdatedAt
...
// checkCity311LocalAccountConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkCity311LocalAccountConstraints(ctx context.Context, res *composeType.City311LocalAccount) (err error) {
	err = func() (err error) {

		// handling string type as default
		if len(res.LoginIdentifier) == 0 {
			// skip check on empty values
			return nil
		}

		ex, err := s.LookupCity311LocalAccountByLoginIdentifier(ctx, res.LoginIdentifier)
		if err == nil && ex != nil && ex.ID != res.ID {
			return store.ErrNotUnique.Stack(1)
		} else if !errors.IsNotFound(err) {
			return err
	...
	err = func() (err error) {
		...
		// handling string type as default
		if len(res.VerifiedEmail) == 0 {
			// skip check on empty values
			return nil
		}

		ex, err := s.LookupCity311LocalAccountByVerifiedEmail(ctx, res.VerifiedEmail)
		if err == nil && ex != nil && ex.ID != res.ID {
			return store.ErrNotUnique.Stack(1)
		} else if !errors.IsNotFound(err) {
			return err
...
// CreateCity311Operation creates one or more rows in city311Operation collection
//
// This function is auto-generated
func (s *Store) CreateCity311Operation(ctx context.Context, rr ...*composeType.City311Operation) (err error) {
	for i := range rr {
		if err = s.checkCity311OperationConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311OperationInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateCity311Operation updates one or more existing entries in city311Operation collection
//
// This function is auto-generated
func (s *Store) UpdateCity311Operation(ctx context.Context, rr ...*composeType.City311Operation) (err error) {
	for i := range rr {
		if err = s.checkCity311OperationConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311OperationUpdateQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpsertCity311Operation updates one or more existing entries in city311Operation collection
//
// This function is auto-generated
func (s *Store) UpsertCity311Operation(ctx context.Context, rr ...*composeType.City311Operation) (err error) {
	for i := range rr {
		if err = s.checkCity311OperationConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, city311OperationUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, city311OperationInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, city311OperationUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteCity311Operation Deletes one or more entries from city311Operation collection
//
// This function is auto-generated
func (s *Store) DeleteCity311Operation(ctx context.Context, rr ...*composeType.City311Operation) (err error) {
	for i := range rr {
		if err = s.Exec(ctx, city311OperationDeleteQuery(s.Dialect.GOQU(), city311OperationPrimaryKeys(rr[i]))); err != nil {
			return
		}
	}
...
// DeleteCity311OperationByID deletes single entry from city311Operation collection
//
// This function is auto-generated
func (s *Store) DeleteCity311OperationByID(ctx context.Context, id uint64) error {
	return s.Exec(ctx, city311OperationDeleteQuery(s.Dialect.GOQU(), goqu.Ex{
		"id": id,
	}))
}

// TruncateCity311Operations Deletes all rows from the city311Operation collection
func (s *Store) TruncateCity311Operations(ctx context.Context) error {
	return s.Exec(ctx, city311OperationTruncateQuery(s.Dialect.GOQU()))
}

// SearchCity311Operations returns (filtered) set of City311Operations
//
// This function is auto-generated
func (s *Store) SearchCity311Operations(ctx context.Context, f composeType.City311OperationFilter) (set composeType.City311OperationSet, _ composeType.City311OperationFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfCity311Operations fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfCity311Operations(ctx, f, sort)
	...
	if f.IncTotal {
		...
		if f.Limit > 0 && uint(len(set)) == f.Limit {
			...
			limit := f.Limit
			f.Limit = 0
			var navSet composeType.City311OperationSet
			if navSet, _, _, err = s.fetchFullPageOfCity311Operations(ctx, f, sort); err != nil {
				return
			} else {
				f.Total = uint(len(navSet))
				f.Limit = limit
...
// fetchFullPageOfCity311Operations collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfCity311Operations(
	ctx context.Context,
	filter composeType.City311OperationFilter,
	sort filter.SortExprSet,
) (set []*composeType.City311Operation, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*composeType.City311Operation
		...
		tryFilter composeType.City311OperationFilter
	)

	set = make([]*composeType.City311Operation, 0, DefaultSliceCapacity)
	...
	for try := 0; try < MaxRefetches; try++ {
		...
		if aux, hasNext, err = s.QueryCity311Operations(ctx, tryFilter); err != nil {
			return nil, nil, nil, err
		}
		...
		if reqItems > collected {
			...
			// Update cursor so that it points to the last item fetched
			tryFilter.PageCursor = s.collectCity311OperationCursorValues(set[collected-1], filter.Sort...)
	...
	if hasPrev {
		prev = s.collectCity311OperationCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectCity311OperationCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
// QueryCity311Operations queries the database, converts and checks each row and returns collected set
//
// With generics, we can remove this per-resource-generated function
// and replace it with a single utility fetcher
//
// This function is auto-generated
func (s *Store) QueryCity311Operations(
	ctx context.Context,
	f composeType.City311OperationFilter,
) (_ []*composeType.City311Operation, more bool, err error) {
	var (
		ok bool

		set         = make([]*composeType.City311Operation, 0, DefaultSliceCapacity)
		res         *composeType.City311Operation
		aux         *auxCity311Operation
		rows        *sql.Rows
		count       uint
		expr, tExpr []goqu.Expression
	...
	if s.Filters.City311Operation != nil {
		// extended filter set
		tExpr, f, err = s.Filters.City311Operation(s, f)
	} else {
		// using generated filter
		tExpr, f, err = City311OperationFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for City311Operation: %w", err)
		return
	}
	...
	// paging feature is enabled
	if f.PageCursor != nil {
		if tExpr, err = cursorWithSorting(f.PageCursor, s.sortableCity311OperationFields()); err != nil {
			return
		} else {
			expr = append(expr, tExpr...)
		}
	...
	query := city311OperationSelectQuery(s.Dialect.GOQU()).Where(expr...)

	// sorting feature is enabled
	if sortExpr, err = order(f.Sort, s.sortableCity311OperationFields()); err != nil {
		err = fmt.Errorf("could not generate order expression for City311Operation: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query City311Operation: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		aux = new(auxCity311Operation)
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for City311Operation: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode City311Operation: %w", err)
			return
		}
...
//
// This function is auto-generated
func (s *Store) LookupCity311OperationByID(ctx context.Context, id uint64) (_ *composeType.City311Operation, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311Operation)
		lookup = city311OperationSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("id").Eq(id),
		).Limit(1)
	)
...
// sortableCity311OperationFields returns all <no value> columns flagged as sortable
//
// # Notes
// With optional string arg, all columns are returned aliased
//
// This function is auto-generated
func (Store) sortableCity311OperationFields() map[string]string {
	return map[string]string{
		"actor_id":     "actor_id",
		"actorid":      "actor_id",
		"completed_at": "completed_at",
...
// collectCity311OperationCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectCity311OperationCursorValues(res *composeType.City311Operation, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
...
// checkCity311OperationConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkCity311OperationConstraints(ctx context.Context, res *composeType.City311Operation) (err error) {
	return nil
}

// CreateCity311PasswordResetToken creates one or more rows in city311PasswordResetToken collection
//
// This function is auto-generated
func (s *Store) CreateCity311PasswordResetToken(ctx context.Context, rr ...*composeType.City311PasswordResetToken) (err error) {
	for i := range rr {
		if err = s.checkCity311PasswordResetTokenConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311PasswordResetTokenInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateCity311PasswordResetToken updates one or more existing entries in city311PasswordResetToken collection
//
// This function is auto-generated
func (s *Store) UpdateCity311PasswordResetToken(ctx context.Context, rr ...*composeType.City311PasswordResetToken) (err error) {
	for i := range rr {
		if err = s.checkCity311PasswordResetTokenConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311PasswordResetTokenUpdateQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpsertCity311PasswordResetToken updates one or more existing entries in city311PasswordResetToken collection
//
// This function is auto-generated
func (s *Store) UpsertCity311PasswordResetToken(ctx context.Context, rr ...*composeType.City311PasswordResetToken) (err error) {
	for i := range rr {
		if err = s.checkCity311PasswordResetTokenConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, city311PasswordResetTokenUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, city311PasswordResetTokenInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, city311PasswordResetTokenUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteCity311PasswordResetToken Deletes one or more entries from city311PasswordResetToken collection
//
// This function is auto-generated
func (s *Store) DeleteCity311PasswordResetToken(ctx context.Context, rr ...*composeType.City311PasswordResetToken) (err error) {
	for i := range rr {
		if err = s.Exec(ctx, city311PasswordResetTokenDeleteQuery(s.Dialect.GOQU(), city311PasswordResetTokenPrimaryKeys(rr[i]))); err != nil {
			return
		}
	}
...
// DeleteCity311PasswordResetTokenByID deletes single entry from city311PasswordResetToken collection
//
// This function is auto-generated
func (s *Store) DeleteCity311PasswordResetTokenByID(ctx context.Context, id uint64) error {
	return s.Exec(ctx, city311PasswordResetTokenDeleteQuery(s.Dialect.GOQU(), goqu.Ex{
		"id": id,
	}))
}

// TruncateCity311PasswordResetTokens Deletes all rows from the city311PasswordResetToken collection
func (s *Store) TruncateCity311PasswordResetTokens(ctx context.Context) error {
	return s.Exec(ctx, city311PasswordResetTokenTruncateQuery(s.Dialect.GOQU()))
}

// SearchCity311PasswordResetTokens returns (filtered) set of City311PasswordResetTokens
//
// This function is auto-generated
func (s *Store) SearchCity311PasswordResetTokens(ctx context.Context, f composeType.City311PasswordResetTokenFilter) (set composeType.City311PasswordResetTokenSet, _ composeType.City311PasswordResetTokenFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfCity311PasswordResetTokens fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfCity311PasswordResetTokens(ctx, f, sort)
	...
	if f.IncTotal {
		...
		if f.Limit > 0 && uint(len(set)) == f.Limit {
			...
			limit := f.Limit
			f.Limit = 0
			var navSet composeType.City311PasswordResetTokenSet
			if navSet, _, _, err = s.fetchFullPageOfCity311PasswordResetTokens(ctx, f, sort); err != nil {
				return
			} else {
				f.Total = uint(len(navSet))
				f.Limit = limit
...
// fetchFullPageOfCity311PasswordResetTokens collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfCity311PasswordResetTokens(
	ctx context.Context,
	filter composeType.City311PasswordResetTokenFilter,
	sort filter.SortExprSet,
) (set []*composeType.City311PasswordResetToken, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*composeType.City311PasswordResetToken
		...
		tryFilter composeType.City311PasswordResetTokenFilter
	)

	set = make([]*composeType.City311PasswordResetToken, 0, DefaultSliceCapacity)
	...
	for try := 0; try < MaxRefetches; try++ {
		...
		if aux, hasNext, err = s.QueryCity311PasswordResetTokens(ctx, tryFilter); err != nil {
			return nil, nil, nil, err
		}
		...
		if reqItems > collected {
			...
			// Update cursor so that it points to the last item fetched
			tryFilter.PageCursor = s.collectCity311PasswordResetTokenCursorValues(set[collected-1], filter.Sort...)
	...
	if hasPrev {
		prev = s.collectCity311PasswordResetTokenCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectCity311PasswordResetTokenCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
// QueryCity311PasswordResetTokens queries the database, converts and checks each row and returns collected set
//
// With generics, we can remove this per-resource-generated function
// and replace it with a single utility fetcher
//
// This function is auto-generated
func (s *Store) QueryCity311PasswordResetTokens(
	ctx context.Context,
	f composeType.City311PasswordResetTokenFilter,
) (_ []*composeType.City311PasswordResetToken, more bool, err error) {
	var (
		ok bool

		set         = make([]*composeType.City311PasswordResetToken, 0, DefaultSliceCapacity)
		res         *composeType.City311PasswordResetToken
		aux         *auxCity311PasswordResetToken
		rows        *sql.Rows
		count       uint
		expr, tExpr []goqu.Expression
	...
	if s.Filters.City311PasswordResetToken != nil {
		// extended filter set
		tExpr, f, err = s.Filters.City311PasswordResetToken(s, f)
	} else {
		// using generated filter
		tExpr, f, err = City311PasswordResetTokenFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for City311PasswordResetToken: %w", err)
		return
	}
	...
	// paging feature is enabled
	if f.PageCursor != nil {
		if tExpr, err = cursorWithSorting(f.PageCursor, s.sortableCity311PasswordResetTokenFields()); err != nil {
			return
		} else {
			expr = append(expr, tExpr...)
		}
	...
	query := city311PasswordResetTokenSelectQuery(s.Dialect.GOQU()).Where(expr...)

	// sorting feature is enabled
	if sortExpr, err = order(f.Sort, s.sortableCity311PasswordResetTokenFields()); err != nil {
		err = fmt.Errorf("could not generate order expression for City311PasswordResetToken: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query City311PasswordResetToken: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		aux = new(auxCity311PasswordResetToken)
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for City311PasswordResetToken: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode City311PasswordResetToken: %w", err)
			return
		}
...
//
// This function is auto-generated
func (s *Store) LookupCity311PasswordResetTokenByID(ctx context.Context, id uint64) (_ *composeType.City311PasswordResetToken, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311PasswordResetToken)
		lookup = city311PasswordResetTokenSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("id").Eq(id),
		).Limit(1)
	)
...
//
// This function is auto-generated
func (s *Store) LookupCity311PasswordResetTokenByTokenHash(ctx context.Context, tokenHash string) (_ *composeType.City311PasswordResetToken, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311PasswordResetToken)
		lookup = city311PasswordResetTokenSelectQuery(s.Dialect.GOQU()).Where(
...
// sortableCity311PasswordResetTokenFields returns all <no value> columns flagged as sortable
//
// # Notes
// With optional string arg, all columns are returned aliased
//
// This function is auto-generated
func (Store) sortableCity311PasswordResetTokenFields() map[string]string {
	return map[string]string{
		"created_at": "created_at",
		"createdat":  "created_at",
		"expires_at": "expires_at",
...
// collectCity311PasswordResetTokenCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectCity311PasswordResetTokenCursorValues(res *composeType.City311PasswordResetToken, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
...
// checkCity311PasswordResetTokenConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkCity311PasswordResetTokenConstraints(ctx context.Context, res *composeType.City311PasswordResetToken) (err error) {
	err = func() (err error) {
		...
		ex, err := s.LookupCity311PasswordResetTokenByTokenHash(ctx, res.TokenHash)
		if err == nil && ex != nil && ex.ID != res.ID {
			return store.ErrNotUnique.Stack(1)
		} else if !errors.IsNotFound(err) {
			return err
...
// CreateCity311ReopenRequest creates one or more rows in city311ReopenRequest collection
//
// This function is auto-generated
func (s *Store) CreateCity311ReopenRequest(ctx context.Context, rr ...*composeType.City311ReopenRequest) (err error) {
	for i := range rr {
		if err = s.checkCity311ReopenRequestConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311ReopenRequestInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateCity311ReopenRequest updates one or more existing entries in city311ReopenRequest collection
//
// This function is auto-generated
func (s *Store) UpdateCity311ReopenRequest(ctx context.Context, rr ...*composeType.City311ReopenRequest) (err error) {
	for i := range rr {
		if err = s.checkCity311ReopenRequestConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311ReopenRequestUpdateQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpsertCity311ReopenRequest updates one or more existing entries in city311ReopenRequest collection
//
// This function is auto-generated
func (s *Store) UpsertCity311ReopenRequest(ctx context.Context, rr ...*composeType.City311ReopenRequest) (err error) {
	for i := range rr {
		if err = s.checkCity311ReopenRequestConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, city311ReopenRequestUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, city311ReopenRequestInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, city311ReopenRequestUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteCity311ReopenRequest Deletes one or more entries from city311ReopenRequest collection
//
// This function is auto-generated
func (s *Store) DeleteCity311ReopenRequest(ctx context.Context, rr ...*composeType.City311ReopenRequest) (err error) {
	for i := range rr {
		if err = s.Exec(ctx, city311ReopenRequestDeleteQuery(s.Dialect.GOQU(), city311ReopenRequestPrimaryKeys(rr[i]))); err != nil {
			return
		}
	}
...
// DeleteCity311ReopenRequestByID deletes single entry from city311ReopenRequest collection
//
// This function is auto-generated
func (s *Store) DeleteCity311ReopenRequestByID(ctx context.Context, id uint64) error {
	return s.Exec(ctx, city311ReopenRequestDeleteQuery(s.Dialect.GOQU(), goqu.Ex{
		"id": id,
	}))
}

// TruncateCity311ReopenRequests Deletes all rows from the city311ReopenRequest collection
func (s *Store) TruncateCity311ReopenRequests(ctx context.Context) error {
	return s.Exec(ctx, city311ReopenRequestTruncateQuery(s.Dialect.GOQU()))
}

// SearchCity311ReopenRequests returns (filtered) set of City311ReopenRequests
//
// This function is auto-generated
func (s *Store) SearchCity311ReopenRequests(ctx context.Context, f composeType.City311ReopenRequestFilter) (set composeType.City311ReopenRequestSet, _ composeType.City311ReopenRequestFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfCity311ReopenRequests fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfCity311ReopenRequests(ctx, f, sort)
	...
	if f.IncTotal {
		...
		if f.Limit > 0 && uint(len(set)) == f.Limit {
			...
			limit := f.Limit
			f.Limit = 0
			var navSet composeType.City311ReopenRequestSet
			if navSet, _, _, err = s.fetchFullPageOfCity311ReopenRequests(ctx, f, sort); err != nil {
				return
			} else {
				f.Total = uint(len(navSet))
				f.Limit = limit
...
// fetchFullPageOfCity311ReopenRequests collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfCity311ReopenRequests(
	ctx context.Context,
	filter composeType.City311ReopenRequestFilter,
	sort filter.SortExprSet,
) (set []*composeType.City311ReopenRequest, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*composeType.City311ReopenRequest
		...
		tryFilter composeType.City311ReopenRequestFilter
	)

	set = make([]*composeType.City311ReopenRequest, 0, DefaultSliceCapacity)
	...
	for try := 0; try < MaxRefetches; try++ {
		...
		if aux, hasNext, err = s.QueryCity311ReopenRequests(ctx, tryFilter); err != nil {
			return nil, nil, nil, err
		}
		...
		if reqItems > collected {
			...
			// Update cursor so that it points to the last item fetched
			tryFilter.PageCursor = s.collectCity311ReopenRequestCursorValues(set[collected-1], filter.Sort...)
	...
	if hasPrev {
		prev = s.collectCity311ReopenRequestCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectCity311ReopenRequestCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
// QueryCity311ReopenRequests queries the database, converts and checks each row and returns collected set
//
// With generics, we can remove this per-resource-generated function
// and replace it with a single utility fetcher
//
// This function is auto-generated
func (s *Store) QueryCity311ReopenRequests(
	ctx context.Context,
	f composeType.City311ReopenRequestFilter,
) (_ []*composeType.City311ReopenRequest, more bool, err error) {
	var (
		ok bool

		set         = make([]*composeType.City311ReopenRequest, 0, DefaultSliceCapacity)
		res         *composeType.City311ReopenRequest
		aux         *auxCity311ReopenRequest
		rows        *sql.Rows
		count       uint
		expr, tExpr []goqu.Expression
	...
	if s.Filters.City311ReopenRequest != nil {
		// extended filter set
		tExpr, f, err = s.Filters.City311ReopenRequest(s, f)
	} else {
		// using generated filter
		tExpr, f, err = City311ReopenRequestFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for City311ReopenRequest: %w", err)
		return
	}
	...
	// paging feature is enabled
	if f.PageCursor != nil {
		if tExpr, err = cursorWithSorting(f.PageCursor, s.sortableCity311ReopenRequestFields()); err != nil {
			return
		} else {
			expr = append(expr, tExpr...)
		}
	...
	query := city311ReopenRequestSelectQuery(s.Dialect.GOQU()).Where(expr...)

	// sorting feature is enabled
	if sortExpr, err = order(f.Sort, s.sortableCity311ReopenRequestFields()); err != nil {
		err = fmt.Errorf("could not generate order expression for City311ReopenRequest: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query City311ReopenRequest: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		aux = new(auxCity311ReopenRequest)
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for City311ReopenRequest: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode City311ReopenRequest: %w", err)
			return
		}
...
//
// This function is auto-generated
func (s *Store) LookupCity311ReopenRequestByID(ctx context.Context, id uint64) (_ *composeType.City311ReopenRequest, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311ReopenRequest)
		lookup = city311ReopenRequestSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("id").Eq(id),
		).Limit(1)
	)
...
// sortableCity311ReopenRequestFields returns all <no value> columns flagged as sortable
//
// # Notes
// With optional string arg, all columns are returned aliased
//
// This function is auto-generated
func (Store) sortableCity311ReopenRequestFields() map[string]string {
	return map[string]string{
...
// collectCity311ReopenRequestCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectCity311ReopenRequestCursorValues(res *composeType.City311ReopenRequest, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
...
// checkCity311ReopenRequestConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkCity311ReopenRequestConstraints(ctx context.Context, res *composeType.City311ReopenRequest) (err error) {
	return nil
}
...
// CreateCity311RequestConstituentLink creates one or more rows in city311RequestConstituentLink collection
//
// This function is auto-generated
func (s *Store) CreateCity311RequestConstituentLink(ctx context.Context, rr ...*composeType.City311RequestConstituent) (err error) {
	for i := range rr {
		if err = s.checkCity311RequestConstituentLinkConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311RequestConstituentLinkInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateCity311RequestConstituentLink updates one or more existing entries in city311RequestConstituentLink collection
//
// This function is auto-generated
func (s *Store) UpdateCity311RequestConstituentLink(ctx context.Context, rr ...*composeType.City311RequestConstituent) (err error) {
	for i := range rr {
		if err = s.checkCity311RequestConstituentLinkConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311RequestConstituentLinkUpdateQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpsertCity311RequestConstituentLink updates one or more existing entries in city311RequestConstituentLink collection
//
// This function is auto-generated
func (s *Store) UpsertCity311RequestConstituentLink(ctx context.Context, rr ...*composeType.City311RequestConstituent) (err error) {
	for i := range rr {
		if err = s.checkCity311RequestConstituentLinkConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, city311RequestConstituentLinkUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, city311RequestConstituentLinkInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, city311RequestConstituentLinkUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteCity311RequestConstituentLink Deletes one or more entries from city311RequestConstituentLink collection
//
// This function is auto-generated
func (s *Store) DeleteCity311RequestConstituentLink(ctx context.Context, rr ...*composeType.City311RequestConstituent) (err error) {
	for i := range rr {
		if err = s.Exec(ctx, city311RequestConstituentLinkDeleteQuery(s.Dialect.GOQU(), city311RequestConstituentLinkPrimaryKeys(rr[i]))); err != nil {
			return
		}
	}
...
// DeleteCity311RequestConstituentLinkByID deletes single entry from city311RequestConstituentLink collection
//
// This function is auto-generated
func (s *Store) DeleteCity311RequestConstituentLinkByID(ctx context.Context, id uint64) error {
	return s.Exec(ctx, city311RequestConstituentLinkDeleteQuery(s.Dialect.GOQU(), goqu.Ex{
		"id": id,
	}))
}

// TruncateCity311RequestConstituentLinks Deletes all rows from the city311RequestConstituentLink collection
func (s *Store) TruncateCity311RequestConstituentLinks(ctx context.Context) error {
	return s.Exec(ctx, city311RequestConstituentLinkTruncateQuery(s.Dialect.GOQU()))
}

// SearchCity311RequestConstituentLinks returns (filtered) set of City311RequestConstituentLinks
//
// This function is auto-generated
func (s *Store) SearchCity311RequestConstituentLinks(ctx context.Context, f composeType.City311RequestConstituentFilter) (set composeType.City311RequestConstituentSet, _ composeType.City311RequestConstituentFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfCity311RequestConstituentLinks fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfCity311RequestConstituentLinks(ctx, f, sort)
	...
	if f.IncTotal {
		...
		if f.Limit > 0 && uint(len(set)) == f.Limit {
			...
			limit := f.Limit
			f.Limit = 0
			var navSet composeType.City311RequestConstituentSet
			if navSet, _, _, err = s.fetchFullPageOfCity311RequestConstituentLinks(ctx, f, sort); err != nil {
				return
			} else {
				f.Total = uint(len(navSet))
				f.Limit = limit
...
// fetchFullPageOfCity311RequestConstituentLinks collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfCity311RequestConstituentLinks(
	ctx context.Context,
	filter composeType.City311RequestConstituentFilter,
	sort filter.SortExprSet,
) (set []*composeType.City311RequestConstituent, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*composeType.City311RequestConstituent
		...
		tryFilter composeType.City311RequestConstituentFilter
	)

	set = make([]*composeType.City311RequestConstituent, 0, DefaultSliceCapacity)
	...
	for try := 0; try < MaxRefetches; try++ {
		...
		if aux, hasNext, err = s.QueryCity311RequestConstituentLinks(ctx, tryFilter); err != nil {
			return nil, nil, nil, err
		}
		...
		if reqItems > collected {
			...
			// Update cursor so that it points to the last item fetched
			tryFilter.PageCursor = s.collectCity311RequestConstituentLinkCursorValues(set[collected-1], filter.Sort...)
	...
	if hasPrev {
		prev = s.collectCity311RequestConstituentLinkCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectCity311RequestConstituentLinkCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
// QueryCity311RequestConstituentLinks queries the database, converts and checks each row and returns collected set
//
// With generics, we can remove this per-resource-generated function
// and replace it with a single utility fetcher
//
// This function is auto-generated
func (s *Store) QueryCity311RequestConstituentLinks(
	ctx context.Context,
	f composeType.City311RequestConstituentFilter,
) (_ []*composeType.City311RequestConstituent, more bool, err error) {
	var (
		ok bool

		set         = make([]*composeType.City311RequestConstituent, 0, DefaultSliceCapacity)
		res         *composeType.City311RequestConstituent
		aux         *auxCity311RequestConstituentLink
		rows        *sql.Rows
		count       uint
		expr, tExpr []goqu.Expression
	...
	if s.Filters.City311RequestConstituentLink != nil {
		// extended filter set
		tExpr, f, err = s.Filters.City311RequestConstituentLink(s, f)
	} else {
		// using generated filter
		tExpr, f, err = City311RequestConstituentLinkFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for City311RequestConstituentLink: %w", err)
		return
	}
	...
	// paging feature is enabled
	if f.PageCursor != nil {
		if tExpr, err = cursorWithSorting(f.PageCursor, s.sortableCity311RequestConstituentLinkFields()); err != nil {
			return
		} else {
			expr = append(expr, tExpr...)
		}
	...
	query := city311RequestConstituentLinkSelectQuery(s.Dialect.GOQU()).Where(expr...)

	// sorting feature is enabled
	if sortExpr, err = order(f.Sort, s.sortableCity311RequestConstituentLinkFields()); err != nil {
		err = fmt.Errorf("could not generate order expression for City311RequestConstituentLink: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query City311RequestConstituentLink: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		aux = new(auxCity311RequestConstituentLink)
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for City311RequestConstituentLink: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode City311RequestConstituentLink: %w", err)
			return
		}
...
//
// This function is auto-generated
func (s *Store) LookupCity311RequestConstituentLinkByID(ctx context.Context, id uint64) (_ *composeType.City311RequestConstituent, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311RequestConstituentLink)
		lookup = city311RequestConstituentLinkSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("id").Eq(id),
		).Limit(1)
	)
...
// sortableCity311RequestConstituentLinkFields returns all <no value> columns flagged as sortable
//
// # Notes
// With optional string arg, all columns are returned aliased
//
// This function is auto-generated
func (Store) sortableCity311RequestConstituentLinkFields() map[string]string {
	return map[string]string{
		"constituent_id":    "constituent_id",
		"constituentid":     "constituent_id",
		"created_at":        "created_at",
...
// collectCity311RequestConstituentLinkCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectCity311RequestConstituentLinkCursorValues(res *composeType.City311RequestConstituent, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
...
// checkCity311RequestConstituentLinkConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkCity311RequestConstituentLinkConstraints(ctx context.Context, res *composeType.City311RequestConstituent) (err error) {
	return nil
}

// CreateCity311RequestNote creates one or more rows in city311RequestNote collection
//
// This function is auto-generated
func (s *Store) CreateCity311RequestNote(ctx context.Context, rr ...*composeType.City311RequestNote) (err error) {
	for i := range rr {
		if err = s.checkCity311RequestNoteConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311RequestNoteInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateCity311RequestNote updates one or more existing entries in city311RequestNote collection
//
// This function is auto-generated
func (s *Store) UpdateCity311RequestNote(ctx context.Context, rr ...*composeType.City311RequestNote) (err error) {
	for i := range rr {
		if err = s.checkCity311RequestNoteConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311RequestNoteUpdateQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpsertCity311RequestNote updates one or more existing entries in city311RequestNote collection
//
// This function is auto-generated
func (s *Store) UpsertCity311RequestNote(ctx context.Context, rr ...*composeType.City311RequestNote) (err error) {
	for i := range rr {
		if err = s.checkCity311RequestNoteConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, city311RequestNoteUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, city311RequestNoteInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, city311RequestNoteUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteCity311RequestNote Deletes one or more entries from city311RequestNote collection
//
// This function is auto-generated
func (s *Store) DeleteCity311RequestNote(ctx context.Context, rr ...*composeType.City311RequestNote) (err error) {
	for i := range rr {
		if err = s.Exec(ctx, city311RequestNoteDeleteQuery(s.Dialect.GOQU(), city311RequestNotePrimaryKeys(rr[i]))); err != nil {
			return
		}
	}
...
// DeleteCity311RequestNoteByID deletes single entry from city311RequestNote collection
//
// This function is auto-generated
func (s *Store) DeleteCity311RequestNoteByID(ctx context.Context, id uint64) error {
	return s.Exec(ctx, city311RequestNoteDeleteQuery(s.Dialect.GOQU(), goqu.Ex{
		"id": id,
	}))
}

// TruncateCity311RequestNotes Deletes all rows from the city311RequestNote collection
func (s *Store) TruncateCity311RequestNotes(ctx context.Context) error {
	return s.Exec(ctx, city311RequestNoteTruncateQuery(s.Dialect.GOQU()))
}

// SearchCity311RequestNotes returns (filtered) set of City311RequestNotes
//
// This function is auto-generated
func (s *Store) SearchCity311RequestNotes(ctx context.Context, f composeType.City311RequestNoteFilter) (set composeType.City311RequestNoteSet, _ composeType.City311RequestNoteFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfCity311RequestNotes fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfCity311RequestNotes(ctx, f, sort)
	...
	if f.IncTotal {
		...
		if f.Limit > 0 && uint(len(set)) == f.Limit {
			...
			limit := f.Limit
			f.Limit = 0
			var navSet composeType.City311RequestNoteSet
			if navSet, _, _, err = s.fetchFullPageOfCity311RequestNotes(ctx, f, sort); err != nil {
				return
			} else {
				f.Total = uint(len(navSet))
				f.Limit = limit
...
// fetchFullPageOfCity311RequestNotes collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfCity311RequestNotes(
	ctx context.Context,
	filter composeType.City311RequestNoteFilter,
	sort filter.SortExprSet,
) (set []*composeType.City311RequestNote, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*composeType.City311RequestNote
		...
		tryFilter composeType.City311RequestNoteFilter
	)

	set = make([]*composeType.City311RequestNote, 0, DefaultSliceCapacity)
	...
	for try := 0; try < MaxRefetches; try++ {
		...
		if aux, hasNext, err = s.QueryCity311RequestNotes(ctx, tryFilter); err != nil {
			return nil, nil, nil, err
		}
		...
		if reqItems > collected {
			...
			// Update cursor so that it points to the last item fetched
			tryFilter.PageCursor = s.collectCity311RequestNoteCursorValues(set[collected-1], filter.Sort...)
	...
	if hasPrev {
		prev = s.collectCity311RequestNoteCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectCity311RequestNoteCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
// QueryCity311RequestNotes queries the database, converts and checks each row and returns collected set
//
// With generics, we can remove this per-resource-generated function
// and replace it with a single utility fetcher
//
// This function is auto-generated
func (s *Store) QueryCity311RequestNotes(
	ctx context.Context,
	f composeType.City311RequestNoteFilter,
) (_ []*composeType.City311RequestNote, more bool, err error) {
	var (
		ok bool

		set         = make([]*composeType.City311RequestNote, 0, DefaultSliceCapacity)
		res         *composeType.City311RequestNote
		aux         *auxCity311RequestNote
		rows        *sql.Rows
		count       uint
		expr, tExpr []goqu.Expression
	...
	if s.Filters.City311RequestNote != nil {
		// extended filter set
		tExpr, f, err = s.Filters.City311RequestNote(s, f)
	} else {
		// using generated filter
		tExpr, f, err = City311RequestNoteFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for City311RequestNote: %w", err)
		return
	}
	...
	// paging feature is enabled
	if f.PageCursor != nil {
		if tExpr, err = cursorWithSorting(f.PageCursor, s.sortableCity311RequestNoteFields()); err != nil {
			return
		} else {
			expr = append(expr, tExpr...)
		}
	...
	query := city311RequestNoteSelectQuery(s.Dialect.GOQU()).Where(expr...)

	// sorting feature is enabled
	if sortExpr, err = order(f.Sort, s.sortableCity311RequestNoteFields()); err != nil {
		err = fmt.Errorf("could not generate order expression for City311RequestNote: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query City311RequestNote: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		aux = new(auxCity311RequestNote)
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for City311RequestNote: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode City311RequestNote: %w", err)
			return
		}
...
//
// This function is auto-generated
func (s *Store) LookupCity311RequestNoteByID(ctx context.Context, id uint64) (_ *composeType.City311RequestNote, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311RequestNote)
		lookup = city311RequestNoteSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("id").Eq(id),
		).Limit(1)
	)
...
// sortableCity311RequestNoteFields returns all <no value> columns flagged as sortable
//
// # Notes
// With optional string arg, all columns are returned aliased
//
// This function is auto-generated
func (Store) sortableCity311RequestNoteFields() map[string]string {
	return map[string]string{
		"created_at": "created_at",
		"createdat":  "created_at",
		"id":         "id",
...
// collectCity311RequestNoteCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectCity311RequestNoteCursorValues(res *composeType.City311RequestNote, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
...
// checkCity311RequestNoteConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkCity311RequestNoteConstraints(ctx context.Context, res *composeType.City311RequestNote) (err error) {
	return nil
}
...
// CreateCity311WorkflowDefinition creates one or more rows in city311WorkflowDefinition collection
//
// This function is auto-generated
func (s *Store) CreateCity311WorkflowDefinition(ctx context.Context, rr ...*composeType.City311WorkflowDefinition) (err error) {
	for i := range rr {
		if err = s.checkCity311WorkflowDefinitionConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311WorkflowDefinitionInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateCity311WorkflowDefinition updates one or more existing entries in city311WorkflowDefinition collection
//
// This function is auto-generated
func (s *Store) UpdateCity311WorkflowDefinition(ctx context.Context, rr ...*composeType.City311WorkflowDefinition) (err error) {
	for i := range rr {
		if err = s.checkCity311WorkflowDefinitionConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311WorkflowDefinitionUpdateQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpsertCity311WorkflowDefinition updates one or more existing entries in city311WorkflowDefinition collection
//
// This function is auto-generated
func (s *Store) UpsertCity311WorkflowDefinition(ctx context.Context, rr ...*composeType.City311WorkflowDefinition) (err error) {
	for i := range rr {
		if err = s.checkCity311WorkflowDefinitionConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, city311WorkflowDefinitionUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, city311WorkflowDefinitionInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, city311WorkflowDefinitionUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteCity311WorkflowDefinition Deletes one or more entries from city311WorkflowDefinition collection
//
// This function is auto-generated
func (s *Store) DeleteCity311WorkflowDefinition(ctx context.Context, rr ...*composeType.City311WorkflowDefinition) (err error) {
	for i := range rr {
		if err = s.Exec(ctx, city311WorkflowDefinitionDeleteQuery(s.Dialect.GOQU(), city311WorkflowDefinitionPrimaryKeys(rr[i]))); err != nil {
			return
		}
	}
...
// DeleteCity311WorkflowDefinitionByID deletes single entry from city311WorkflowDefinition collection
//
// This function is auto-generated
func (s *Store) DeleteCity311WorkflowDefinitionByID(ctx context.Context, id uint64) error {
	return s.Exec(ctx, city311WorkflowDefinitionDeleteQuery(s.Dialect.GOQU(), goqu.Ex{
		"id": id,
	}))
}

// TruncateCity311WorkflowDefinitions Deletes all rows from the city311WorkflowDefinition collection
func (s *Store) TruncateCity311WorkflowDefinitions(ctx context.Context) error {
	return s.Exec(ctx, city311WorkflowDefinitionTruncateQuery(s.Dialect.GOQU()))
}

// SearchCity311WorkflowDefinitions returns (filtered) set of City311WorkflowDefinitions
//
// This function is auto-generated
func (s *Store) SearchCity311WorkflowDefinitions(ctx context.Context, f composeType.City311WorkflowDefinitionFilter) (set composeType.City311WorkflowDefinitionSet, _ composeType.City311WorkflowDefinitionFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfCity311WorkflowDefinitions fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfCity311WorkflowDefinitions(ctx, f, sort)
	...
	if f.IncTotal {
		...
		if f.Limit > 0 && uint(len(set)) == f.Limit {
			...
			limit := f.Limit
			f.Limit = 0
			var navSet composeType.City311WorkflowDefinitionSet
			if navSet, _, _, err = s.fetchFullPageOfCity311WorkflowDefinitions(ctx, f, sort); err != nil {
				return
			} else {
				f.Total = uint(len(navSet))
				f.Limit = limit
...
// fetchFullPageOfCity311WorkflowDefinitions collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfCity311WorkflowDefinitions(
	ctx context.Context,
	filter composeType.City311WorkflowDefinitionFilter,
	sort filter.SortExprSet,
) (set []*composeType.City311WorkflowDefinition, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*composeType.City311WorkflowDefinition
		...
		tryFilter composeType.City311WorkflowDefinitionFilter
	)

	set = make([]*composeType.City311WorkflowDefinition, 0, DefaultSliceCapacity)
	...
	for try := 0; try < MaxRefetches; try++ {
		...
		if aux, hasNext, err = s.QueryCity311WorkflowDefinitions(ctx, tryFilter); err != nil {
			return nil, nil, nil, err
		}
		...
		if reqItems > collected {
			...
			// Update cursor so that it points to the last item fetched
			tryFilter.PageCursor = s.collectCity311WorkflowDefinitionCursorValues(set[collected-1], filter.Sort...)
	...
	if hasPrev {
		prev = s.collectCity311WorkflowDefinitionCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectCity311WorkflowDefinitionCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
// QueryCity311WorkflowDefinitions queries the database, converts and checks each row and returns collected set
//
// With generics, we can remove this per-resource-generated function
// and replace it with a single utility fetcher
//
// This function is auto-generated
func (s *Store) QueryCity311WorkflowDefinitions(
	ctx context.Context,
	f composeType.City311WorkflowDefinitionFilter,
) (_ []*composeType.City311WorkflowDefinition, more bool, err error) {
	var (
		ok bool

		set         = make([]*composeType.City311WorkflowDefinition, 0, DefaultSliceCapacity)
		res         *composeType.City311WorkflowDefinition
		aux         *auxCity311WorkflowDefinition
		rows        *sql.Rows
		count       uint
		expr, tExpr []goqu.Expression
	...
	if s.Filters.City311WorkflowDefinition != nil {
		// extended filter set
		tExpr, f, err = s.Filters.City311WorkflowDefinition(s, f)
	} else {
		// using generated filter
		tExpr, f, err = City311WorkflowDefinitionFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for City311WorkflowDefinition: %w", err)
		return
	}
	...
	// paging feature is enabled
	if f.PageCursor != nil {
		if tExpr, err = cursorWithSorting(f.PageCursor, s.sortableCity311WorkflowDefinitionFields()); err != nil {
			return
		} else {
			expr = append(expr, tExpr...)
		}
	...
	query := city311WorkflowDefinitionSelectQuery(s.Dialect.GOQU()).Where(expr...)

	// sorting feature is enabled
	if sortExpr, err = order(f.Sort, s.sortableCity311WorkflowDefinitionFields()); err != nil {
		err = fmt.Errorf("could not generate order expression for City311WorkflowDefinition: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query City311WorkflowDefinition: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		aux = new(auxCity311WorkflowDefinition)
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for City311WorkflowDefinition: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode City311WorkflowDefinition: %w", err)
			return
		}
...
//
// This function is auto-generated
func (s *Store) LookupCity311WorkflowDefinitionByID(ctx context.Context, id uint64) (_ *composeType.City311WorkflowDefinition, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311WorkflowDefinition)
		lookup = city311WorkflowDefinitionSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("id").Eq(id),
		).Limit(1)
	)
...
//
// This function is auto-generated
func (s *Store) LookupCity311WorkflowDefinitionByWorkflowID(ctx context.Context, workflowID string) (_ *composeType.City311WorkflowDefinition, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311WorkflowDefinition)
		lookup = city311WorkflowDefinitionSelectQuery(s.Dialect.GOQU()).Where(
...
// sortableCity311WorkflowDefinitionFields returns all <no value> columns flagged as sortable
//
// # Notes
// With optional string arg, all columns are returned aliased
//
// This function is auto-generated
func (Store) sortableCity311WorkflowDefinitionFields() map[string]string {
	return map[string]string{
		"active":      "active",
		"created_at":  "created_at",
		"createdat":   "created_at",
...
// collectCity311WorkflowDefinitionCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectCity311WorkflowDefinitionCursorValues(res *composeType.City311WorkflowDefinition, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
...
// checkCity311WorkflowDefinitionConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkCity311WorkflowDefinitionConstraints(ctx context.Context, res *composeType.City311WorkflowDefinition) (err error) {
	err = func() (err error) {

		// handling string type as default
		if len(res.WorkflowID) == 0 {
			// skip check on empty values
			return nil
		}

		ex, err := s.LookupCity311WorkflowDefinitionByWorkflowID(ctx, res.WorkflowID)
		if err == nil && ex != nil && ex.ID != res.ID {
			return store.ErrNotUnique.Stack(1)
		} else if !errors.IsNotFound(err) {
			return err
...
// CreateCity311WorkflowExecution creates one or more rows in city311WorkflowExecution collection
//
// This function is auto-generated
func (s *Store) CreateCity311WorkflowExecution(ctx context.Context, rr ...*composeType.City311WorkflowExecution) (err error) {
	for i := range rr {
		if err = s.checkCity311WorkflowExecutionConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311WorkflowExecutionInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateCity311WorkflowExecution updates one or more existing entries in city311WorkflowExecution collection
//
// This function is auto-generated
func (s *Store) UpdateCity311WorkflowExecution(ctx context.Context, rr ...*composeType.City311WorkflowExecution) (err error) {
	for i := range rr {
		if err = s.checkCity311WorkflowExecutionConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311WorkflowExecutionUpdateQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpsertCity311WorkflowExecution updates one or more existing entries in city311WorkflowExecution collection
//
// This function is auto-generated
func (s *Store) UpsertCity311WorkflowExecution(ctx context.Context, rr ...*composeType.City311WorkflowExecution) (err error) {
	for i := range rr {
		if err = s.checkCity311WorkflowExecutionConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, city311WorkflowExecutionUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, city311WorkflowExecutionInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, city311WorkflowExecutionUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteCity311WorkflowExecution Deletes one or more entries from city311WorkflowExecution collection
//
// This function is auto-generated
func (s *Store) DeleteCity311WorkflowExecution(ctx context.Context, rr ...*composeType.City311WorkflowExecution) (err error) {
	for i := range rr {
		if err = s.Exec(ctx, city311WorkflowExecutionDeleteQuery(s.Dialect.GOQU(), city311WorkflowExecutionPrimaryKeys(rr[i]))); err != nil {
			return
		}
	}
...
// DeleteCity311WorkflowExecutionByID deletes single entry from city311WorkflowExecution collection
//
// This function is auto-generated
func (s *Store) DeleteCity311WorkflowExecutionByID(ctx context.Context, id uint64) error {
	return s.Exec(ctx, city311WorkflowExecutionDeleteQuery(s.Dialect.GOQU(), goqu.Ex{
		"id": id,
	}))
}

// TruncateCity311WorkflowExecutions Deletes all rows from the city311WorkflowExecution collection
func (s *Store) TruncateCity311WorkflowExecutions(ctx context.Context) error {
	return s.Exec(ctx, city311WorkflowExecutionTruncateQuery(s.Dialect.GOQU()))
}

// SearchCity311WorkflowExecutions returns (filtered) set of City311WorkflowExecutions
//
// This function is auto-generated
func (s *Store) SearchCity311WorkflowExecutions(ctx context.Context, f composeType.City311WorkflowExecutionFilter) (set composeType.City311WorkflowExecutionSet, _ composeType.City311WorkflowExecutionFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfCity311WorkflowExecutions fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfCity311WorkflowExecutions(ctx, f, sort)
	...
	if f.IncTotal {
		...
		if f.Limit > 0 && uint(len(set)) == f.Limit {
			...
			limit := f.Limit
			f.Limit = 0
			var navSet composeType.City311WorkflowExecutionSet
			if navSet, _, _, err = s.fetchFullPageOfCity311WorkflowExecutions(ctx, f, sort); err != nil {
				return
			} else {
				f.Total = uint(len(navSet))
				f.Limit = limit
...
// fetchFullPageOfCity311WorkflowExecutions collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfCity311WorkflowExecutions(
	ctx context.Context,
	filter composeType.City311WorkflowExecutionFilter,
	sort filter.SortExprSet,
) (set []*composeType.City311WorkflowExecution, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*composeType.City311WorkflowExecution
		...
		tryFilter composeType.City311WorkflowExecutionFilter
	)

	set = make([]*composeType.City311WorkflowExecution, 0, DefaultSliceCapacity)
	...
	for try := 0; try < MaxRefetches; try++ {
		...
		if aux, hasNext, err = s.QueryCity311WorkflowExecutions(ctx, tryFilter); err != nil {
			return nil, nil, nil, err
		}
		...
		if reqItems > collected {
			...
			// Update cursor so that it points to the last item fetched
			tryFilter.PageCursor = s.collectCity311WorkflowExecutionCursorValues(set[collected-1], filter.Sort...)
	...
	if hasPrev {
		prev = s.collectCity311WorkflowExecutionCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectCity311WorkflowExecutionCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
// QueryCity311WorkflowExecutions queries the database, converts and checks each row and returns collected set
//
// With generics, we can remove this per-resource-generated function
// and replace it with a single utility fetcher
//
// This function is auto-generated
func (s *Store) QueryCity311WorkflowExecutions(
	ctx context.Context,
	f composeType.City311WorkflowExecutionFilter,
) (_ []*composeType.City311WorkflowExecution, more bool, err error) {
	var (
		ok bool

		set         = make([]*composeType.City311WorkflowExecution, 0, DefaultSliceCapacity)
		res         *composeType.City311WorkflowExecution
		aux         *auxCity311WorkflowExecution
		rows        *sql.Rows
		count       uint
		expr, tExpr []goqu.Expression
	...
	if s.Filters.City311WorkflowExecution != nil {
		// extended filter set
		tExpr, f, err = s.Filters.City311WorkflowExecution(s, f)
	} else {
		// using generated filter
		tExpr, f, err = City311WorkflowExecutionFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for City311WorkflowExecution: %w", err)
		return
	}
	...
	// paging feature is enabled
	if f.PageCursor != nil {
		if tExpr, err = cursorWithSorting(f.PageCursor, s.sortableCity311WorkflowExecutionFields()); err != nil {
			return
		} else {
			expr = append(expr, tExpr...)
		}
	...
	query := city311WorkflowExecutionSelectQuery(s.Dialect.GOQU()).Where(expr...)

	// sorting feature is enabled
	if sortExpr, err = order(f.Sort, s.sortableCity311WorkflowExecutionFields()); err != nil {
		err = fmt.Errorf("could not generate order expression for City311WorkflowExecution: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query City311WorkflowExecution: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		aux = new(auxCity311WorkflowExecution)
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for City311WorkflowExecution: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode City311WorkflowExecution: %w", err)
			return
		}
...
//
// This function is auto-generated
func (s *Store) LookupCity311WorkflowExecutionByID(ctx context.Context, id uint64) (_ *composeType.City311WorkflowExecution, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311WorkflowExecution)
		lookup = city311WorkflowExecutionSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("id").Eq(id),
		).Limit(1)
	)
...
//
// This function is auto-generated
func (s *Store) LookupCity311WorkflowExecutionByExecutionID(ctx context.Context, executionID string) (_ *composeType.City311WorkflowExecution, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311WorkflowExecution)
		lookup = city311WorkflowExecutionSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("execution_id").Eq(executionID),
		).Limit(1)
	)
...
// sortableCity311WorkflowExecutionFields returns all <no value> columns flagged as sortable
//
// # Notes
// With optional string arg, all columns are returned aliased
//
// This function is auto-generated
func (Store) sortableCity311WorkflowExecutionFields() map[string]string {
	return map[string]string{
...
// collectCity311WorkflowExecutionCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectCity311WorkflowExecutionCursorValues(res *composeType.City311WorkflowExecution, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
...
// checkCity311WorkflowExecutionConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkCity311WorkflowExecutionConstraints(ctx context.Context, res *composeType.City311WorkflowExecution) (err error) {
	err = func() (err error) {

		// handling string type as default
		if len(res.ExecutionID) == 0 {
			// skip check on empty values
			return nil
		}

		ex, err := s.LookupCity311WorkflowExecutionByExecutionID(ctx, res.ExecutionID)
		if err == nil && ex != nil && ex.ID != res.ID {
			return store.ErrNotUnique.Stack(1)
		} else if !errors.IsNotFound(err) {
			return err
