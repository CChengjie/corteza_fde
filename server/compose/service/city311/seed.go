...
var seedActors = []seedActor{
	...
	{Handle: "city311-service-agent", Name: "City 311 Service Agent", Email: "service-agent@city311.example.invalid", Role: contract.ApplicationRoleServiceAgent, Department: contract.DepartmentStreets, Districts: []contract.DistrictCode{contract.DistrictNorth}, PasswordEnv: seedStaffPasswordEnv},
	{Handle: "city311-supervisor", Name: "City 311 Supervisor", Email: "supervisor@city311.example.invalid", Role: contract.ApplicationRoleSupervisor, Department: contract.DepartmentStreets, Districts: []contract.DistrictCode{contract.DistrictNorth, contract.DistrictCentral}, PasswordEnv: seedStaffPasswordEnv},
	{Handle: "city311-department-manager", Name: "City 311 Department Manager", Email: "department-manager@city311.example.invalid", Role: contract.ApplicationRoleDepartmentManager, Department: contract.DepartmentStreets, Districts: []contract.DistrictCode{contract.DistrictNorth, contract.DistrictCentral, contract.DistrictSouth}, PasswordEnv: seedStaffPasswordEnv},
	{Handle: "city311-platform-administrator", Name: "City 311 Platform Administrator", Email: "platform-admin@city311.example.invalid", Role: contract.ApplicationRolePlatformAdministrator, PasswordEnv: seedAdministratorPasswordEnv},
	{Handle: "city311-workflow-designer", Name: "City 311 Workflow Designer", Email: "workflow-designer@city311.example.invalid", Role: contract.ApplicationRoleWorkflowDesigner, Department: contract.DepartmentGeneralServices, Districts: []contract.DistrictCode{contract.DistrictCentral}, PasswordEnv: seedStaffPasswordEnv},
