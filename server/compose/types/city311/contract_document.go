	...
	document := ContractDocument{
		...
		Decisions: []ContractDecision{
			...
			},
			{
				...
				Decision:   "actor_role contains only asserted staff roles; constituent is actor_type, public visitors are unauthenticated, and integration clients are represented by OAuth scopes",
			},
		},
